...
const TIPS = [
  {
    ...
    desc: 'Start at 50% of the quoted price, be friendly, walk away if too high — the vendor will often call you back.',
  },
  {
    icon: '💵',
    title: 'Spot 20k vs 500k Notes',
    desc: 'Always check the color and size. The 500k note is larger with a blue tint. Under UV light, security features glow.',
  },
  {
    icon: '🏧',
    title: 'ATM Tips for Tourists',
    desc: 'Use ATMs inside banks to avoid skimmers. Vietcombank & BIDV ATMs accept Visa/Mastercard with low fees.',
  },
  {
    icon: '📱',
    title: 'Pay with Grab/MoMo',
    desc: 'Download Grab for rides & food delivery. MoMo works at many shops if you have a local phone number.',
  },
];
      ...
      <div className="landing-page" style={{ paddingTop: 72 }}>
        ...
        <section id="financial-dashboard" className="lp-dashboard lp-section">
          ...
          <p className="lp-section-subtitle">
            Track your budget, convert currencies instantly, and take control of your
            travel spending.
          </p>
          ...
          <div className="lp-dashboard-grid">
            ...
            >
              <div className="lp-budget-header">
                ...
                {budgetData ? (
                  ...
                  {budgetData.name ?? 'Active'}
                </span>
                ) : (
                    <span className="lp-budget-badge">
                  {isLoggedIn ? 'No Budget' : 'Preview'}
                </span>
                )}
              </div>
            ...
            <div className="lp-glass lp-converter-card">
              ...
              <p className="lp-converter-sub">
                See how much your money is worth in Vietnamese Đồng
              </p>
          ...
          <div className="lp-utility-grid">
            <div className="lp-glass lp-util-card" onClick={() => navigate('/atm-map')}>
              ...
              <p className="lp-util-card-desc">
                Locate international-card friendly ATMs (Visa/Mastercard) near you
                instantly.
              </p>

              <div className="lp-util-highlight">
                🟢 Tap to find ATMs near you
              </div>
            </div>
            ...
            <div className="lp-glass lp-util-card" onClick={() => navigate('/plans')}>
              ...
              <p className="lp-util-card-desc">
                Smart itineraries, budget estimates, and local recommendations for
                your trip.
              </p>
          ...
          <div className="lp-footer-inner">
            <div className="lp-footer-grid">
              <div className="lp-footer-brand">
                ...
                <p>
                  The smart financial companion for tourists in Vietnam. Scan, track,
                  convert, and travel with confidence.
                </p>
              </div>
              ...
              <div>
                ...
                <ul className="lp-footer-links">
                  <li>
                    <a href="/scan">AI Money Scanner</a>
                  </li>
                  <li>
              ...
              <div>
                ...
                <ul className="lp-footer-links">
                  <li>
                    <a href="/atm-map">ATM Finder</a>
                  </li>
                  <li>
                    <a href="/plans">Travel Planner</a>
                  </li>
                  <li>
                    <a href="/spots">Tourist Spots</a>
                  </li>
                  <li>
                    <a href="/news">Travel News</a>
                  </li>
                </ul>
              </div>
