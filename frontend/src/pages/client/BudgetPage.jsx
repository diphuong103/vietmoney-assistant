...
const SectionTitle = ({ children, action }) => (
  <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '0 20px', paddingRight: 70, margin: '20px 0 10px' }}>
...
const useStyles = () => ({
  ...
  px: { padding: '0 20px', paddingRight: 70 },
...
export default function BudgetPage() {
  ...
  // ─────────────────────────────────────────────────────────────────────────────
  return (
    <div className="page active" id="page-budget" style={{ paddingBottom: 100, overflowY: 'auto' }}>
      ...
      {/* ── HERO CARD ── */}
      <div style={{ padding: '12px 20px 0', paddingRight: 70 }}>
        <div style={{
      ...
      {/* ── BENTO QUICK STATS ── */}
      <div style={{ height: 20 }} />
      <div style={{ padding: '0 20px', paddingRight: 70 }}>
      ...
      <SectionTitle action={
        <button
          ...
          style={{
            ...
            background: 'var(--bg3,var(--color-background-secondary))',
            border: '0.5px solid var(--border,var(--color-border-tertiary))',
            fontSize: 12, fontWeight: 600, cursor: 'pointer', color: 'var(--muted)',
            transition: 'all .2s',
          }}
        >
          ✏️ Danh mục
      ...
      {/* FABs removed – controls moved to Navbar and Category Analysis section */}
